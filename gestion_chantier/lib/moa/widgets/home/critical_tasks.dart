...
import 'package:gestion_chantier/moa/services/CriticalsTask.dart';
...
class _CriticalTasksWidgetState extends State<CriticalTasksWidget> {
  ...
  Future<void> _loadCriticalTasks() async {
    ...
    try {
      // Mode MOA: agrège les tâches de tous les promoteurs
      final tasks =
          await _criticalTasksService.getCriticalTasksSafelyAllPromoters();
