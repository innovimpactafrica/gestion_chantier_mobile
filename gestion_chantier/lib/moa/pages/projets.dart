...
import 'package:gestion_chantier/moa/bloc/projet/projet_bloc.dart';
import 'package:gestion_chantier/moa/bloc/projet/projet_event.dart';
import 'package:gestion_chantier/moa/bloc/projet/projet_state.dart';
import 'package:gestion_chantier/moa/models/RealEstateModel.dart';
import 'package:gestion_chantier/moa/utils/HexColor.dart';
import 'package:gestion_chantier/moa/widgets/navitems_projet.dart';
import 'package:gestion_chantier/moa/widgets/projetsaccueil/projet_card.dart';
import 'package:gestion_chantier/moa/bloc/projets/projet_bloc.dart' as nav;
...
class _ProjetsPageState extends State<ProjetsPage> {
  ...
  void initState() {
    super.initState();
    // En mode MOA, on veut tous les projets => fetchAll: true
    _projetsBloc = ProjetsBloc(
  ...
  void _onProjetTap(RealEstateModel projet) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (context) => BlocProvider<nav.NavigationBloc>(
              create: (_) => nav.NavigationBloc(),
              child: MainProjectScreenWrapper(projet: projet),
            ),
      ),
    );
  }
