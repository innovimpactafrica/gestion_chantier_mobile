...
import 'package:gestion_chantier/manager/pages/projets/detail.dart';
import 'package:gestion_chantier/manager/pages/projets/document.dart';
import 'package:gestion_chantier/manager/pages/projets/signalement.dart';
import 'package:gestion_chantier/manager/pages/projets/stock.dart';
...
class _MainProjectScreenWrapperState extends State<MainProjectScreenWrapper> {
  ...
  Widget _getPage(BuildContext context) {
    ...
    final pages = [
      // Page 0: Project details avec tabs (maintenant utilise le widget réutilisable)
      ProjectDetailWidget(
