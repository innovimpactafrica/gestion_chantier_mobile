...
class ProjetsBloc extends Bloc<ProjetsEvent, ProjetsState> {
  ...
  final bool fetchAll; // Mode pour récupérer tous les projets (MOA)
  ...
  Future<void> _onLoadProjets(
    ...
    try {
      final projets =
          fetchAll
              ? await _realEstateService.getAllProjectsForAllPromoters()
              : await _realEstateService.getPromoterProjects(promoterId);
      _allProjets = projets;
